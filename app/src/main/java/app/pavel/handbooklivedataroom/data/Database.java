...
public abstract class Database extends RoomDatabase {
    ...
    private final static List<Category> CATEGORIES = Arrays.asList(
            ...
            new Category("Winter Olympics: Britain's Elise Christie 'fearless' despite fall in 500m final", "Great Britain's Elise Christie says she will \"still be racing fearless\" at the Winter Olympics, despite falling in the 500m short-track speed skating final.\n" +
                    "\n" +
            ...
            new Category("Chinese woman joins handbag in X-ray machine", "Worried about your bags being stolen at security? One Chinese woman joined her handbag through an X-ray machine to prevent just that.\n" +
                    "\n" +
